...
namespace AnyThinkAds.Android
{
    public class ATInterstitialAdClient : AndroidJavaProxy,IATInterstitialAdClient
    {
        ...
        public ATInterstitialAdClient() : base("com.secmtp.sdk.unitybridge.interstitial.InterstitialListener")
        {
            interstitialAutoAdHelper = new AndroidJavaObject("com.secmtp.sdk.unitybridge.interstitial.InterstitialAutoAdHelper", this);
        }
        ...
        public void loadInterstitialAd(string placementId, string mapJson)
        {
            ...
            if(!interstitialHelperMap.ContainsKey(placementId))
            {
                AndroidJavaObject videoHelper = new AndroidJavaObject(
                    "com.secmtp.sdk.unitybridge.interstitial.InterstitialHelper", this);
